...
public class DisplayMessageActivity extends AppCompatActivity {
    ...
    private EditText editText_leave_time;
...
//        retrieve the data from the arrival and leave time fields from the view
        ...
        editText_leave_time = (EditText) findViewById(R.id.leave_time);
        ...
        editText_leave_time.setOnFocusChangeListener(new View.OnFocusChangeListener() {

            public void onFocusChange(View v, boolean hasFocus) {
                if(!hasFocus){
                    String leave_time =  editText_leave_time.getText().toString();
                    try {
                        leave_date = (Date)formatter.parse(leave_time);
                    } catch (java.text.ParseException e) {
                        e.printStackTrace();
                    }
                }
